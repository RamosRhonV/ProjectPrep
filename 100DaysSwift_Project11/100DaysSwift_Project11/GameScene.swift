        ...
        if let touch = touches.first {
            ...
            if objects.contains(editLabel) {
                ...
                if editingMode {
                    ...
                    switch (randColor) {
                    case 0: ballName = "ballRed"
                    case 1: ballName = "ballPurple"
                    case 2: ballName = "ballGreen"
                    case 3: ballName = "ballYellow"
                    case 4: ballName = "ballCyan"
                    default: ballName = "ballGray"
                    }
